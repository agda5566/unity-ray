...
public class ThirdPersonController : MonoBehaviour {
	...
	void Draw(){
		...
		player.GetComponent<Rigidbody>().velocity = new Vector3 (player.GetComponent<Rigidbody>().velocity.x, this.originYVelocity, player.GetComponent<Rigidbody>().velocity.z);
	}
	...
	void Update () {
		...
		this.originYVelocity = player.GetComponent<Rigidbody>().velocity.y;
